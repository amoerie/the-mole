                    ...
                    SELECT json_group_array(
                        CASE
                            WHEN json_extract(c.value, '$.Name') = 'Abigail'
                                ...
                                '$.HighResPhotoUrl', COALESCE(json_extract(c.value, '$.HighResPhotoUrl'), 'https://images.play.tv/styles/e571973e3f87726813c649d14b960d4bd8fafb9e5b6fa4f53d8b064e3df4a4f1/meta/demols14500x500abigail-tcb0dt.png'),
                            ...
                            WHEN json_extract(c.value, '$.Name') = 'Dries'
                                 AND (json_extract(c.value, '$.Bio') IS NULL OR json_extract(c.value, '$.HighResPhotoUrl') IS NULL) THEN json_set(c.value,
                                '$.HighResPhotoUrl', COALESCE(json_extract(c.value, '$.HighResPhotoUrl'), 'https://images.play.tv/styles/e571973e3f87726813c649d14b960d4bd8fafb9e5b6fa4f53d8b064e3df4a4f1/meta/demols14500x500dries-tcb0qr.png'),
                            ...
                            WHEN json_extract(c.value, '$.Name') = 'Isabel'
                                 AND (json_extract(c.value, '$.Bio') IS NULL OR json_extract(c.value, '$.HighResPhotoUrl') IS NULL) THEN json_set(c.value,
                                '$.HighResPhotoUrl', COALESCE(json_extract(c.value, '$.HighResPhotoUrl'), 'https://images.play.tv/styles/e571973e3f87726813c649d14b960d4bd8fafb9e5b6fa4f53d8b064e3df4a4f1/meta/demols14500x500isabel-tcb11c.png'),
                            ...
                            WHEN json_extract(c.value, '$.Name') = 'Julie'
                                 AND (json_extract(c.value, '$.Bio') IS NULL OR json_extract(c.value, '$.HighResPhotoUrl') IS NULL) THEN json_set(c.value,
                                '$.HighResPhotoUrl', COALESCE(json_extract(c.value, '$.HighResPhotoUrl'), 'https://images.play.tv/styles/e571973e3f87726813c649d14b960d4bd8fafb9e5b6fa4f53d8b064e3df4a4f1/meta/demols14500x500julie-tcb14l.png'),
                            ...
                            WHEN json_extract(c.value, '$.Name') = 'Karla'
                                 AND (json_extract(c.value, '$.Bio') IS NULL OR json_extract(c.value, '$.HighResPhotoUrl') IS NULL) THEN json_set(c.value,
                                '$.HighResPhotoUrl', COALESCE(json_extract(c.value, '$.HighResPhotoUrl'), 'https://images.play.tv/styles/e571973e3f87726813c649d14b960d4bd8fafb9e5b6fa4f53d8b064e3df4a4f1/meta/demols14500x500karla-tcb19o.png'),
                            ...
                            WHEN json_extract(c.value, '$.Name') = 'Kristof'
                                 AND (json_extract(c.value, '$.Bio') IS NULL OR json_extract(c.value, '$.HighResPhotoUrl') IS NULL) THEN json_set(c.value,
                                '$.HighResPhotoUrl', COALESCE(json_extract(c.value, '$.HighResPhotoUrl'), 'https://images.play.tv/styles/e571973e3f87726813c649d14b960d4bd8fafb9e5b6fa4f53d8b064e3df4a4f1/meta/demols14500x500kristof-tcb1ct.png'),
                            ...
                            WHEN json_extract(c.value, '$.Name') = 'Maïté'
                                 AND (json_extract(c.value, '$.Bio') IS NULL OR json_extract(c.value, '$.HighResPhotoUrl') IS NULL) THEN json_set(c.value,
                                '$.HighResPhotoUrl', COALESCE(json_extract(c.value, '$.HighResPhotoUrl'), '/contestants/maite.png'),
                            ...
                            WHEN json_extract(c.value, '$.Name') = 'Maxim'
                                 AND (json_extract(c.value, '$.Bio') IS NULL OR json_extract(c.value, '$.HighResPhotoUrl') IS NULL) THEN json_set(c.value,
                                '$.HighResPhotoUrl', COALESCE(json_extract(c.value, '$.HighResPhotoUrl'), 'https://images.play.tv/styles/e571973e3f87726813c649d14b960d4bd8fafb9e5b6fa4f53d8b064e3df4a4f1/meta/demols14500x500maxim-tcb1k7.png'),
                            ...
                            WHEN json_extract(c.value, '$.Name') = 'Vincent'
                                 AND (json_extract(c.value, '$.Bio') IS NULL OR json_extract(c.value, '$.HighResPhotoUrl') IS NULL) THEN json_set(c.value,
                                '$.HighResPhotoUrl', COALESCE(json_extract(c.value, '$.HighResPhotoUrl'), 'https://images.play.tv/styles/e571973e3f87726813c649d14b960d4bd8fafb9e5b6fa4f53d8b064e3df4a4f1/meta/demols14500x500vincent-tcb1mj.png'),
                            ...
                            WHEN json_extract(c.value, '$.Name') = 'Wout'
                                 AND (json_extract(c.value, '$.Bio') IS NULL OR json_extract(c.value, '$.HighResPhotoUrl') IS NULL) THEN json_set(c.value,
                                '$.HighResPhotoUrl', COALESCE(json_extract(c.value, '$.HighResPhotoUrl'), 'https://images.play.tv/styles/e571973e3f87726813c649d14b960d4bd8fafb9e5b6fa4f53d8b064e3df4a4f1/meta/demols14500x500wout-tcb1pm.png'),
                            ...
                            WHEN json_extract(c.value, '$.Name') = 'Yana'
                                 AND (json_extract(c.value, '$.Bio') IS NULL OR json_extract(c.value, '$.HighResPhotoUrl') IS NULL) THEN json_set(c.value,
                                '$.HighResPhotoUrl', COALESCE(json_extract(c.value, '$.HighResPhotoUrl'), 'https://images.play.tv/styles/e571973e3f87726813c649d14b960d4bd8fafb9e5b6fa4f53d8b064e3df4a4f1/meta/demols14500x500yana-tco1fq.png'),
                            ...
                            WHEN json_extract(c.value, '$.Name') = 'Yannis'
                                 AND (json_extract(c.value, '$.Bio') IS NULL OR json_extract(c.value, '$.HighResPhotoUrl') IS NULL) THEN json_set(c.value,
                                '$.HighResPhotoUrl', COALESCE(json_extract(c.value, '$.HighResPhotoUrl'), 'https://images.play.tv/styles/e571973e3f87726813c649d14b960d4bd8fafb9e5b6fa4f53d8b064e3df4a4f1/meta/demols14500x500yannis-tco1ng.png'),
