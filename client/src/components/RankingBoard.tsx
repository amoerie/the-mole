...
function SortableItem({ contestant, rank, disabled }: { contestant: Contestant; rank: number; disabled?: boolean }) {
  const {
    attributes,
    listeners,
    setNodeRef,
...
export default function RankingBoard({ contestants, initialOrder, onSubmit, disabled }: RankingBoardProps) {
